...
//		job.setNumReduceTasks(1);//设置reduce任务的数量。默认值就是1
			...
			FileInputFormat.addInputPath(job, new Path("friendsRecommend/qqIn.txt"));
			FileOutputFormat.setOutputPath(job, new Path("friendsRecommend/qqOut.txt"));//如果已经有了该文件，可能会执行出错。要先删掉
